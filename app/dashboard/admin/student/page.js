...
export default function AllPlacedStudentsScreen() {
            ...
            .then((res) => {
                if (res.status === 200) {
                    res.json().then((data) => {
                        ...
                        const groupedData = data["students"].reduce(
                            (acc, obj) => {
    ...
    useEffect(() => {
        if (allPlacedStudentData.length && companyList.length) {
            setAllPlacedStudentDataFiltered(
                allPlacedStudentData.filter((student) => {
                    return (
                        ...
                        (selectedCompanies === null ||
                            ...
                            student["placements"].some((placement) => {
                        ...
                        (isGirlsDrive === null ||
                            ...
                            student["placements"].some((placement) => {
                                return (
                                    placement["isGirlsDrive"] === isGirlsDrive
                                );
                            })) &&
                        (isPlaced === null ||
                            isPlaced === "" ||
        ...
        allPlacedStudentDataFiltered.forEach((student) => {
            student["placements"].forEach((placement) => {
                ...
                if (
                    isOnCampus !== null &&
                    isOnCampus !== "" &&
                    placement["isOnCampus"] !== isOnCampus
                ) {
                    return;
                }
                ...
                if (
                    selectedCompanies !== null &&
                    selectedCompanies.length !== 0 &&
                    !selectedCompanies.includes(placement["companyId"])
                ) {
                    return;
                }
    ...
    const isValidBatch =
        batchRegex.test(studentBatch) &&
        parseInt(studentBatch) >= 2018 &&
        parseInt(studentBatch) <= new Date().getFullYear() + 2 &&
        parseInt(studentBatch) != currentBatch;
                            ...
                            <div className="flex flex-wrap border-t border-bGray justify-center items-center xl:flex-row">
                                ...
                                <div className="border-bGray p-4 xl:border-b-0 xl:border-r">
                                    <MultiSelect
                                        ...
                                        options={companyList}
                                        filter
                                        filterPlaceholder="Enter Company Name"
                        ...
                        <table className="max-w-11/12 ml-auto mr-auto my-4 rounded-2xl backdrop-blur-2xl bg-red-50 bg-opacity-30 text-center text-sm border-black border-separate border-spacing-0 border-solid">
                            <thead className="border-0 text-lg font-medium">
                                <tr className="bg-black text-white bg-opacity-90 backdrop-blur-xl">
                                    <th
                                        className="px-2 py-1 rounded-tl-2xl border-black"
                                        rowSpan={2}
                                    >
                                        Roll Number
                                    </th>
                                    ...
                                    <th
                                        className="px-2 py-1 border-b-black rounded-tr-2xl"
                                        rowSpan={1}
                                        colSpan={4}
                                    >
                                        Placements
                                ...
                                <tr className="bg-black text-white bg-opacity-90">
                                    <th className="px-1 py-1 border-black">
                                        Company
                                    </th>
                                    <th className="px-2 py-1 border-black">
                                        CTC
                                    </th>
                                    <th className="px-2 py-1 border-black">
                                        Location
                            ...
                            <tbody>
                                {allPlacedStudentDataFiltered.length === 0 ? (
                                    <tr>
                                        <td
                                            className="border border-gray-200 rounded-b-2xl px-2 py-8 text-center text-lg"
                                            colSpan={9}
                                        >
                                            No Data Found
                                        </td>
                                    ...
                                    allPlacedStudentDataFiltered.map(
                                        (student, index) => {
                                            return [
                                                    ...
                                                    <tr key={index}>
                                                        ...
                                                        >
                                                            ...
                                                            <Link
                                                                ...
                                                                href={`/dashboard/admin/student/${student["studentId"]}`}
                                                            >
                                                                {
                                                                    student[
                                                                        "studentRollNo"
                                                        ...
                                                        >
                                                            {student[
                                                                ...
                                                                <span className="bg-blue-100 rounded-xl p-2 w-fit text-[#0e1d3a]">
                                                                    Higher
                                                                    Studies
                                                                </span>
                                                            ) : (
                                                                <span className="bg-red-100 rounded-xl p-2 text-[#320f0f] w-fit">
                                                                    Not Placed
                                                                </span>
                                                            )}
                                                        </td>
                                                                ...
                                                                >
                                                                    <div className="flex flex-wrap">
                                                                        ...
                                                                        "1" ? (
                                                                            ...
                                                                            <div className="bg-red-100 rounded-xl p-2 m-1 text-[#320f0f]">
                                                                                Off
                                                                                Campus
                                                                            </div>
                                                                        )}
