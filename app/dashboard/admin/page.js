    ...
    useEffect(() => {
        ...
        fetch(GET_TOP_5_PLACEMENTS_URL, {
            ...
            if (res.status === 200) {
                ...
                alertError(
                    "Error",
                    "Something went wrong in fetching top 5 placements. Please try again later.",
                );
            }
        });
            ...
            try {
                ...
                if (response.status === 200) {
                    ...
                    if (
                        ...
                        alertError(
                            "Error",
                            "Something went wrong in adding company. Please try again later.",
                        );
                    }
        ...
        if (userAccess === null || userAccess === undefined) {
            ...
            try {
                ...
                if (response.status === 200) {
                    ...
                    alertError(
                        "Error",
                        "Something went wrong in adding official. Please try again later.",
                    );
                }
                ...
                <main>
                        ...
                        <div className="relative isolate px-6 lg:px-8 justify-center items-center m-auto pt-8">
                            ...
                            <div className="relative mx-6 my-8 py-2 flex flex-wrap justify-center gap-4 items-center md:mx-16">
                                <div className="border flex flex-col rounded-xl backdrop-blur-xl bg-red-50 bg-opacity-30 w-fit max-w-4/5">
                                    <h1 className="px-4 pt-2 text-[#1d0e3a] text-center text-xl">
                                        Placements
                                    </h1>
                                ...
                                <div className="border flex flex-col rounded-xl backdrop-blur-xl bg-red-50 bg-opacity-30 ">
                                    <h1 className="px-4 pt-2 text-[#21430e] text-center text-xl">
                                        Officials
                                    </h1>
                                ...
                                <div className="border flex flex-col rounded-xl backdrop-blur-xl bg-red-50 bg-opacity-30 ">
                                    <h1 className="px-4 pt-2 text-[#403914] text-center text-xl">
                                        Students
                                    </h1>
                                ...
                                <div className="border flex flex-col rounded-xl backdrop-blur-xl bg-red-50 bg-opacity-30">
                                    <h1 className="px-4 pt-2 text-[#461348] text-center text-xl">
                                        Companies
                                    </h1>
                    ...
                    <Transition appear show={registerModalIsOpen} as={Fragment}>
                        <Dialog
                            ...
                            onClose={closeRegisterOfficialModal}
                        >
                            <Transition.Child
                                as={Fragment}
