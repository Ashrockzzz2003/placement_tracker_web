                    ...
                    <header className="absolute inset-x-0 top-0 z-50">
                        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                            ...
                            <div className="flex lg:flex lg:flex-1 lg:justify-end">
                                <Link href={"/dashboard/admin/student"} className="bg-[#000000] text-[#ffffff] rounded-xl p-2 items-center align-middle flex flex-row hover:bg-[#3b3b3b]">
                        ...
                        <div className="relative mx-6 my-8 py-2 flex flex-wrap justify-center gap-4 items-center md:mx-16">
                            {studentPlacements.length === 0 ? (
                                ...
                                studentPlacements.map((placement, index) => {
                                    return (
                                        <StudentPlacementCard cardType={"1"} placementData={placement} key={index} />
                                    )
                                })
                            )}
                        </div>
