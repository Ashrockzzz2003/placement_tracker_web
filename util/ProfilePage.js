...
export function ProfilePage({ profileData, roleInfo }) {
    if (!profileData) {
    ...
    return (
        <>
            <main className="mb-16" data-aos="fade-in">
                <header className="relative inset-x-0 top-0 z-50">
                    ...
                    >
                        <div className="lg:flex lg:gap-x-12">
                            <Link href={roleInfo.dashboardPath}>
                                <Image
                                    src="/logo.png"
                                    alt="Amrita logo"
                                    width={128}
                ...
                <div className="relative mt-4 mx-auto max-w-lg px-4">
                    <div
