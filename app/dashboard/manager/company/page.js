                                ...
                                {companyHireDataFiltered.length === 0 ? (
                                    ...
                                    companyHireDataFiltered.map((data, index) => {
                                        ...
                                        return [
                                            (
                                                <tr key={index}>
                                                    <td className={"border border-gray-200 px-4 py-2" + (index === companyHireDataFiltered.length - 1 ? "border-separate rounded-bl-2xl" : "")} rowSpan={data.recruitData.length + 1}><Link className="underline cursor-pointer" href={`/dashboard/manager/company/${data.companyId.toString()}`}>{data.companyName}</Link></td>
                                                </tr>
                                            ),
                                            (
