...
export default function AllOfficialsScreen() {
    ...
    useEffect(() => {
        ...
        if (
            secureLocalStorage.getItem("userAccess") === null ||
            secureLocalStorage.getItem("userAccess") === undefined
        ) {
    ...
    useEffect(() => {
        if (officials.length) {
            setOfficialsFiltered(
                officials.filter((official) => {
                    return (
                        (official["managerName"]
                            .toLowerCase()
                            .includes(searchText.toLowerCase()) ||
                            official["managerEmail"]
                                .toLowerCase()
                                .includes(searchText.toLowerCase()) ||
                            official["id"].toString().includes(searchText)) &&
                        (role === null
                            ? true
                            : official["managerRole"] === role) &&
                        (status === null
                            ? true
                            : official["accountStatus"] === status)
                    );
                }),
            );
        }
                        ...
                        <table className="max-w-11/12 ml-auto mr-auto my-4 rounded-2xl backdrop-blur-2xl bg-red-50 bg-opacity-30 text-center text-sm border-black border-separate border-spacing-0 border-solid">
                            <thead className="border-0 text-lg font-medium">
                                <tr className="bg-black text-white bg-opacity-90 backdrop-blur-xl">
                                    <th className="px-8 py-4 rounded-tl-2xl border-black">
                                        ID
                                    </th>
                                    <th className="px-8 py-4 border-black">
                                        Name
                                    </th>
                                    <th className="px-8 py-4border-black">
                                        Email-ID
                                    </th>
                                    <th className="px-8 py-4 border-black">
                                        Role
                                    ...
                                    <th className="px-8 py-4 rounded-tr-2xl border-black">
                                        Actions
                                    </th>
                                </tr>
                            </thead>
                                ...
                                {officialsFiltered.length === 0 ? (
                                    ...
                                    officialsFiltered.map((official, index) => {
                                        return (
                                            <tr
                                                key={index}
                                                className="border-black border-opacity-50 border-2"
                                            >
                                                <td
                                                    className={
                                                        "border px-8 py-4" +
                                                ...
                                                {official["managerRole"] ===
                                                    ...
                                                    <td className="border items-center">
                                                        <span className="bg-red-100 rounded-xl p-2 w-fit text-[#320f0f]">
                                                            Unknown
                                                        </span>
                                                    </td>
                                                )}
                                                ...
                                                {official["accountStatus"] ===
                                                    ...
                                                    >
                                                        <span className="bg-green-100 rounded-xl p-2 w-fit text-[#21430e]">
                                                            Active
                                                        </span>
                                                    </td>
                                                ) : official[
                                                    ...
                                                    >
                                                        <span className="bg-yellow-100 rounded-xl p-2 w-fit text-[#544a15]">
                                                            Waitlist
                                                        </span>
                                                    </td>
                                                ) : official[
                                                ...
                                                {official["accountStatus"] ===
                                                    ...
                                                    >
                                                        <button
                                                            ...
                                                            className="bg-green-100 rounded-xl p-2 w-fit text-[#21430e] flex flex-row"
                                                        >
                                                    ...
                                                    >
                                                        <button
                                                            ...
                                                            className="bg-red-100 rounded-xl p-2 w-fit text-[#320f0f] flex flex-row"
                                                        >
                                                            <span className="material-icons mr-2">
                                                                dangerous
                                                            </span>
                                                    ...
                                                    >
                                                        <button className="bg-gray-100 rounded-xl p-2 w-fit text-[#5e5e5e] hover:cursor-not-allowed">
                                                            No Action
                                                        </button>
                                                    </td>
                                                )}
