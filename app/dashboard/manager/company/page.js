...
export default function AllCompaniesScreen() {
                                ...
                                if (
                                    ...
                                    finalData.push({
                                        ...
                                        sectionData: JSON.parse(
                                            `{"${data[i]["studentSection"]}": ${data[i]["totalHires"]}}`,
                                        ),
                                    });
                                    k += 1;
                                }
    ...
    useEffect(() => {
        if (companyHireData.length > 0) {
            setCompanyHireDataFiltered(
                companyHireData.filter((data) => {
                        ...
                        <table className="max-w-11/12 ml-auto mr-auto my-4 rounded-2xl backdrop-blur-2xl bg-red-50 bg-opacity-30 text-center text-sm border-black border-separate border-spacing-0 border-solid">
                            <thead className="border-0 text-lg font-medium">
                                <tr className="bg-black text-white bg-opacity-90 backdrop-blur-xl">
                                    <th
                                        className="px-4 py-2 rounded-tl-2xl border-black"
                                        rowSpan={2}
                                    >
                                        Company Name
                                    </th>
                                    ...
                                    <th
                                        className="px-4 py-2 border-b-black"
                                        rowSpan={1}
                                        colSpan={
                                    ...
                                    <th
                                        className="px-4 py-2 border-black rounded-tr-2xl"
                                        rowSpan={2}
                                    >
                                        Total Hires
                                    </th>
                            ...
                            <tbody>
                                {companyHireDataFiltered.length === 0 ? (
                                    <tr>
                                        <td
                                            className="border border-gray-200 rounded-b-2xl px-4 py-8 text-center text-lg"
                                            colSpan={9}
                                        >
                                            No Data Found
                                        </td>
                                                ...
                                                <tr key={index}>
                                                    ...
                                                    >
                                                        <Link
                                                            ...
                                                            href={`/dashboard/manager/company/${data.companyId.toString()}`}
                                                        >
                                                            {data.companyName}
                                                        </Link>
                                                    </td>
                                                </tr>,
                                                data.recruitData.map(
                                                    (pdata, pindex) => {
                                                        return (
                                                            <tr key={pindex}>
