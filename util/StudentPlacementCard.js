...
export default function StudentPlacementCard({ placementData, cardType, studentId }) {
    ...
    const openEditPlacementAdmin = (placementID) => {
        window.open(`/dashboard/admin/student/${studentId}/editPlacement/${placementID}`, "_parent");
    }
    ...
    return cardType === "1" ? (
        ...
        //             <button onClick={()=>openEditPlacementAdmin(placementData.placementID)}><span className="material-icons pt-2">edit_square</span></button>
        //         </div>
