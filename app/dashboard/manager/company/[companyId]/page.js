...
export default function CompanyPage() {
    ...
    const [deptSectionWiseHiredStudents, setDeptSectionWiseHiredStudents] =
        useState([]);
    const [
        sortedDeptSectionWiseHiredStudents,
        setSortedDeptSectionWiseHiredStudents,
    ] = useState([]);
                        ...
                        {allHiredStudents.length === 0 ? (
                            ...
                            <>
                                ...
                                <div className="relative mx-6 my-8 py-2 flex flex-wrap justify-center gap-4 items-center md:mx-16">
                                    {sortedDeptSectionWiseHiredStudents.map(
                                        (deptSectionWiseHire, index) => {
                                            return (
                                                <div
                                                    key={index}
                                                    className="flex flex-col rounded-xl backdrop-blur-xl bg-green-100 text-[#21430e] shadow-lg"
                                                >
                                                    <span className="text-center p-2">
                                                        {
                                                            deptSectionWiseHire.studentDept
                                                        }{" "}
                                                        {
                                                            deptSectionWiseHire.studentSection
                                                        }
                                                    </span>
                                                    <hr className="border-[#21430e] w-full" />
                                                    <span className="text-center p-2">
                                                        {
                                                            deptSectionWiseHire.totalHires
                                                        }
                                                    </span>
                                                </div>
                                            );
                                ...
                                <div className="flex flex-wrap justify-center items-center mx-auto mb-8">
                                    <Chart
                                        type="bar"
                                        data={{
                                            labels: sortedDeptSectionWiseHiredStudents.map(
                                                (student) =>
                                                    student.studentDept +
                                                    " " +
                                            ...
                                            datasets: [
                                                {
                                                    ...
                                                    data: sortedDeptSectionWiseHiredStudents.map(
                                                        (student) =>
                                                            student.totalHires,
                                                    ),
                                                },
                                ...
                                <table className="max-w-11/12 ml-auto mr-auto my-4 rounded-2xl backdrop-blur-2xl bg-red-50 bg-opacity-30 text-center text-sm border-black border-separate border-spacing-0 border-solid">
                                    <thead className="border-0 text-lg font-medium">
                                        <tr className="bg-black text-white bg-opacity-90 backdrop-blur-xl">
                                            <th className="px-2 py-1 rounded-tl-2xl border-black">
                                                Roll Number
                                            </th>
                                            ...
                                            <th className="px-2 py-1 border-black rounded-tr-2xl">
                                                Quick Facts
                                            </th>
                                        </tr>
                                    </thead>
