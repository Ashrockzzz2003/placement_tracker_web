...
export const STUDENT_REGISTER_VERIFY_URL = BASE_URL + "/auth/studentLoginVerify";
...
export const FORGOT_PASSWORD_VERIFY_URL = BASE_URL + "/auth/resetPasswordVerify";
...
export const GET_TOP_5_PLACEMENTS_URL = BASE_URL + "/manager/getTopFivePlacements";
...
export const GET_ALL_PLACEMENTS_URL = BASE_URL + "/student/getAllPlacedStudentData";
...
export const GET_REGISTERED_OFFICIALS_URL = BASE_URL + "/manager/getRegisteredOfficials";
export const TOGGLE_ACCOUNT_STATUS_URL = BASE_URL + "/manager/toggleOfficialStatus";
export const GET_COMPANY_HIRE_DATA_URL = BASE_URL + "/manager/getCompanyHireDataById";
export const GET_COMPANY_DATA_BY_BATCH_URL = BASE_URL + "/manager/getCompanyHireDataByBatch";
export const ADD_NEW_STUDENT_URL = BASE_URL + "/student/addStudent";


export const GET_STUDENT_PLACEMENTS_URL = BASE_URL + "/student/getStudentPlacements";
export const STUDENT_EDIT_PLACEMENT_URL = BASE_URL + "/manager/editPlacementDataById";