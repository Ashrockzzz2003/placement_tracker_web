                    ...
                    <div className="mx-auto max-w-2xl py-48 lg:py-56">
                        ...
                        <div className="text-center">
                            ...
                            <p className="mt-6 text-lg leading-8 text-gray-600">
                                ...
                                started. Sign In to access your dashboard if you
                                are already registered.
                            </p>
                            <div className="mt-10 flex items-center justify-center gap-x-6">
                                <Link
                                    href={"/login"}
                                    className="bg-[#000000] text-[#ffffff] rounded-lg items-center align-middle flex flex-row hover:bg-[#202020] text-lg px-2 py-1"
                                >
